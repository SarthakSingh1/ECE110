...
SIGNAL \ALT_INV_Or1~0_combout\ : std_logic;
...
\ALT_INV_Or1~0_combout\ <= NOT \Or1~0_combout\;
...
-- Equation(s):
-- \Or1~0_combout\ = ( \S2~input_o\ & ( \S1~input_o\ ) ) # ( !\S2~input_o\ & ( \S0~input_o\ ) )
...
\Or2~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \Or2~0_combout\ = ( \S2~input_o\ & ( \S0~input_o\ ) ) # ( !\S2~input_o\ & ( \S1~input_o\ ) )
